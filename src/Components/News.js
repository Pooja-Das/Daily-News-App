...
import NewsItem from './Newstitle'
...
export class News extends Component {
    ...
    render() {
        return (
            <>
                <h1 className="text-center my-5" style={{ margin: '38px 5px' }}>Daily News - Top {this.capitalizeFirstLetter(this.props.category)} Headlines</h1>
